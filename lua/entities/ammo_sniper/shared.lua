...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("ammo_sniper")
...
function ENT:Initialize()
	...
	local model = ("models/sniper_ammo_h2.mdl")
...
function ENT:PhysicsCollide(data, physobj)
	...
	if (data.Speed > 80 and data.DeltaTime > 0.2) then
		self.Entity:EmitSound("halo2/smg/clipdrop"..math.random(1,10)..".wav")
	end
end
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) and not self.Planted then
		...
		self.Entity:EmitSound("halo2/sniper/sniper_ammo.wav")
		activator:GiveAmmo(4, "ammo_sniper")
		self.Entity:Remove()
	end
end
