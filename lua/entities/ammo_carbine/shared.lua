ENT.Type 			= "anim"
ENT.Base 			= "base_anim"
ENT.PrintName		= "Covenant Carbine Ammo"
ENT.Category		= "Halo 2 Ammo"
...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("ammo_carbine")
...
function ENT:Initialize()
	...
	local model = ("models/carbine_ammo.mdl")
...
function ENT:PhysicsCollide(data, physobj)
	...
	if (data.Speed > 80 and data.DeltaTime > 0.2) then
		self.Entity:EmitSound("halo2/covenant carbine/carbine_clip"..math.random(1,3)..".wav")
	end
end
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) and not self.Planted then
		...
		activator:GiveAmmo(18, "ammo_carbine")
		self.Entity:EmitSound("halo2/covenant carbine/carbine_ammo_pickup2.wav")
		self.Entity:Remove()
	end
end
...
function ENT:Draw()
	...
	local ledcolor = Color(0, 161, 255, 255)

  	local TargetPos = self.Entity:GetPos() + (self.Entity:GetUp() * 2.3) + (self.Entity:GetRight() * 2) + (self.Entity:GetForward() * 1.5)
	...
	self.Text = "Covenant Carbine Ammo"
