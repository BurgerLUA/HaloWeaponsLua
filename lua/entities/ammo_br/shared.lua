ENT.Type 			= "anim"
ENT.Base 			= "base_anim"
ENT.PrintName		= "Batle rifle Ammo"
...
function ENT:Initialize()
	...
	local model = ("models/brifle_h2_ammo.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) and not self.Planted then
		...
		activator:GiveAmmo(36, "ammo_br")
		self.Entity:EmitSound("halo2/battle/battle_rifle_ammo1.wav")
		self.Entity:Remove()
	end
end
