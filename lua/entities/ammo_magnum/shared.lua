...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("ammo_magnum")
...
function ENT:Initialize()
	...
	local model = ("models/magnumh2_ammo.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) and not self.Planted then
		...
		activator:GiveAmmo(12, "ammo_magnum")
		self.Entity:EmitSound("halo2/magnum/magnum_ammo.wav")
		self.Entity:Remove()
	end
end
