...
function EFFECT:Init(data)
	...
	if emitter != nil then	
		local particle = emitter:Add( "effects/fuel_rod_contrails", self.Position - self.Forward * 0)
		...
		for i = 1,4 do
			local particle = emitter:Add( "effects/fuel_rod_contrails", self.Position )
				...
				particle:SetStartSize( math.Rand( 20, 21 ) )
